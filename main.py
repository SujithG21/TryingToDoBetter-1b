...
def main():
    ...
    input_json_path = '/Users/sujith/Desktop/adobe-1b/Collection 1/collection1_input.json'
    output_json_path = '/Users/sujith/Desktop/adobe-1b/output/challenge1b_output1.json'
    ...
    print(f"\nFinal analysis saved to {output_json_path}")
